<template>
    <div class='body'>
        <div class="form">
            <el-form :model="form" size='small'  label-width='80px' label-position='left' ref="Form" :rules="rules" >
                <el-row :gutter='20'>
                ...
                <el-row :gutter='20'>
                    <el-col :xl='3' :lg='3' :md='4' :sm='8' :xs='8'>
                        <el-button size='mini' type="primary" @click="post">上传<i class="el-icon-upload el-icon--right"></i></el-button>
                    </el-col>
                    <el-col :xl='3' :lg='3' :md='4' :sm='8' :xs='8'>
                        <el-button size='mini' type="info">重置<i class="el-icon-delete el-icon--right"></i></el-button>
                    </el-col>
                </el-row>
            </el-form>
        </div>
        <div class="tinymce" style="padding: 20px;">
            <tinymce :content.sync='content'></tinymce>
        </div>
